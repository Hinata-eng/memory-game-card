...
const cardsData = [
    { icon: "./image/Kiwi.webp", name: "Kiwi" },
    { icon: "./image/avocado.webp", name: "avocado" },
    { icon: "./image/Banana.webp", name: "Banana" },
    { icon: "./image/Mulberry.webp", name: "Mulberry" },
    { icon: "./image/peach.webp", name: "peach" },
    { icon: "./image/grapes.png", name: "grapes" }
];
